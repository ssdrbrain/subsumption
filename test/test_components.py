...
class Test(unittest.TestCase):
    def test_global_component_decorator(self):
        @global_component(author="A")
        class TestComponent:
            pass
        ...
        self.assertTrue(component_info['global'])
    ...
    def test_uses_global_interface(self):
        @global_component()
        @uses_global_interface('a')
        @uses_global_interface('b', 'c')
        class TestComponent:
            def __init__(self):
